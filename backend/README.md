...
## Project Structure
    ...
    ├── testapiautostoryboa_96114  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_96114`
...
2. Clone this repo and `cd testapiautostoryboa_96114`
